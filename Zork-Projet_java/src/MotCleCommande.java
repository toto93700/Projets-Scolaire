...
public class MotCleCommande {
	 ...
	 */
	private final static String commandesValides[] = {"regle","aller","lister","description","monSac","prendre","deposer","donner","listerChien","adopterChien","libererChien","mesChien","fini","quitter", "aide"};
