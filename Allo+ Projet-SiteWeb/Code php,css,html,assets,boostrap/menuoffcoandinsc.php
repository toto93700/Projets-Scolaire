...
/* <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link" href="profil.php?id=<?=$_SESSION['ID_compte']?>" >Profil</a>
        </li>
        <li class="nav-item">
 ...
 <div id="bandeauJaune">
    ...
    <div id="menuProfil" class="linkMenu">
        <a href="profil.php?id=<?=$_SESSION['ID_compte']?>">Profil</a>
    </div>
    <div id="menuForum" class="linkMenu">
    ...
    <div id="menuSeDeconnecter" class="linkMenu">
...
function rechercher(){
   ...
   window.open("http://" + window.location.host + "/ma_Recherche_film.php?nom="+elementRechercher.value, "_self");
}
</script>
